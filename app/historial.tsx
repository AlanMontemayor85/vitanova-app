          ...
          cierres.map((c) => {
            ...
            return (
              <View key={c.id} style={styles.cierreCard}>
                ...
                {/* ======================================================== */}
{/* 👑 TARJETA DE REPORTE CONSOLIDADO (DENTRO DEL MAP DE c)   */}
{/* ======================================================== */}
...
{/* 👑 SECCIÓN INTEGRADA: REGISTROS DE CONFORT DE ESTE REPORTE */}
{/* Extaer los parámetros directamente de la instancia 'c' para evitar loops cruzados */}
...
{(notasTareas.length > 0 || tieneNotaNativa) && (
  ...
  </View> // 🎯 Cierre de la tarjeta individual (styles.cierreCard o el contenedor de 'c')
);
          })
        )}
